...
const DonutChart = ({ data = [], title = "Chart Title" }) => {
    ...
    <div className="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
      <div className="flex justify-between mb-3">
        <div className="flex justify-center items-center">
          <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">{title}</h5>
      ...
      <div className="py-6" id="donut-chart">
        <Chart options={getChartOptions()} series={data.map(item => item.value)} type="donut" height={320} />
      </div>
